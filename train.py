...
def run(config):
  ...
  #  scheduler = get_scheduler(config, optimizer, last_epoch)
    ...
    val_dataloaders = get_dataloader(config.data_classifier, './data/data_val.csv',config.val_classifier.batch_size, 'val', config.transform_classifier.num_preprocessor, get_transform(config.transform_classifier, 'val'))
